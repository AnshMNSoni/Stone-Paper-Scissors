...
class GameUI:
    def __init__(self):
        ...
        # Rock Button:
        self.img_rock = PhotoImage(file='Rock.png')
        ...
        # Paper Button:
        self.img_paper = PhotoImage(file='Paper.png')
        ...
        # Scissors Button:
        self.img_scissor = PhotoImage(file='Scissors.png')
        ...
        self.img_Big_Rock = PhotoImage(file='Big_Rock.png')
        self.img_Big_Paper = PhotoImage(file='Big_Paper.png')
        self.img_Big_Scissor = PhotoImage(file='Big_Scissors.png')
    ...
    def End(self):
        ...
        if is_yes:
            ...
            # Reset canvases:
            self.img_grey = PhotoImage(file='grey.png')
